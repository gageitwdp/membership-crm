...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            <?php echo e(Form::label('member_limit',__('Member Limit'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::number('member_limit',null,array('class'=>'form-control','placeholder'=>__('Enter member limit'),'required'=>'required'))); ?>

        </div>
        <div class="form-group">
            <?php echo e(Form::label('membership_plan_limit',__('Membership Plan Limit'),array('class'=>'form-label'))); ?>

            <?php echo e(Form::number('membership_plan_limit',null,array('class'=>'form-control','placeholder'=>__('Enter membership plan limit'),'required'=>'required'))); ?>
...
<?php /**PATH /home/u417948420/domains/members-triumphwest.triumphtrained.com/public_html/main_file/resources/views/subscription/create.blade.php ENDPATH**/ ?>