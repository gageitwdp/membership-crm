...
<?php $__env->startSection('card-action-btn'); ?>
    <?php if(Gate::check('manage document type')): ?>
        <a class="btn btn-secondary btn-sm customModal" href="#" data-size="md"
            data-url="<?php echo e(route('document-type.create')); ?>" data-title="<?php echo e(__('Create Type')); ?>"> <i class="ti-plus mr-5"></i>
            ...
            <div class="card table-card">
                <div class="card-header">
                    <div class="row align-items-center g-2">
                        ...
                        <?php if(Gate::check('create document type')): ?>
                            <div class="col-auto">
                                <a href="#" class="btn btn-secondary customModal" data-size="md"
                                    data-url="<?php echo e(route('document-type.create')); ?>"
                                    data-title="<?php echo e(__('Create Document Type')); ?> ">
                                        ...
                                        <?php if(Gate::check('edit document type') || Gate::check('delete document type')): ?>
                                            <td>
                                                <div class="cart-action">
                                                    <?php echo Form::open(['method' => 'DELETE', 'route' => ['document-type.destroy', $type->id]]); ?>
                                                    ...
                                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit document type')): ?>
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary customModal" data-bs-toggle="tooltip"
                                                            ...
                                                            data-size="md" data-url="<?php echo e(route('document-type.edit', $type)); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u417948420/domains/members-triumphwest.triumphtrained.com/public_html/main_file/resources/views/document_type/index.blade.php ENDPATH**/ ?>